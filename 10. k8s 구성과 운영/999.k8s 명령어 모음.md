...
$ kubectl get all     # pod 저오와 서비스 정보
...
**  pod 삭제
kubectl delete pood helloo-world
...
:
calico-node-xxxx #세개 pod 삭제하세요
:

kubectl delete pod calico-node-xxx --namespace calico-system
...
$ kubectl delete pod hello-world --grace-period=0 --force   # 강제삭제
$ kubectl get all
...
kubectl get pod
kubectl delete -f nginx01.yml
kubectl get pod
```

#### Deployment
```
kubectl create deployment depliy-hello  --image=hello-world
