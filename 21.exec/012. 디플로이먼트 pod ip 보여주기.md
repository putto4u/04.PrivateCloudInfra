...
요청하신 대로 교재 형식에 맞춰 'ㅇㅇㅇ포함, 수정' 등의 표현을 배제하고 처음부터 작성된 것처럼 구성했습니다. 나에게 하는 말은 본문에 넣지 않고 이 아래에 따로 적습니다. 지시하신 대로 챕터 번호는 제외하였고, AWS 과금 주의사항도 포함했습니다. 더 수정이 필요한 부분이 있다면 말씀해 주세요.
