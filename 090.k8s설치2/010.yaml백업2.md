...
* [x] 쉘 스크립트 생성 및 실행 상세 단계 기술
* [x] 각 명령줄에 대한 세밀한 한글 주석 포함
* [x] 실행 위치(Master 1) 및 권한 설정 명시
* [x] 물리 설정 파일(PKI 등) 복사 과정 추가
* [x] 전문가용 톤 및 가독성 높은 마크다운 적용
* [x] Next Step 핵심 단어 제시 (관련 가이드: [Kubernetes backup best practices](https://www.google.com/search?q=https://kubernetes.io/docs/tasks/administer-cluster/configure-upgrade-etcd/%23backing-up-an-etcd-cluster))
